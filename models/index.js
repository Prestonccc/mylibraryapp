...
CONNECTION_STRING = "mongodb+srv://preston:qazharry1209@cluster0.ugaml.mongodb.net/myFirstDatabase?retryWrites=true&w=majority"
...
db.once("open", async () => {console.log("Mongo connection started on " + db.host + ":" + db.port)})
